...
class PersonenFactory {
    static func maakPersonen() -> [Persoon] {
        ...
        let persoonJelle = Persoon(voornaam: "Jelle", familienaam: "De Snelle", adres: adresJelle, telefoonNummer: "0486652781", coordinaten: coordinatenJelle, foto: "arnold")
        ...
        let persoonKevin = Persoon(voornaam: "Kevin", familienaam: "Kevermans", adres: adresKevin, telefoonNummer: "0474952364", coordinaten: coordinatenKevin, foto: "marcel")
        ...
        let persoonMike = Persoon(voornaam: "Mike", familienaam: "De Macho", adres: adresMike, telefoonNummer: "0463285179", coordinaten: coordinatenMike, foto: "trump")
        ...
        let persoonJochen = Persoon(voornaam: "Jochen", familienaam: "Oneindigverenverder", adres: adresJochen, telefoonNummer: "0458921136", coordinaten: coordinatenJochen, foto: "steve")
